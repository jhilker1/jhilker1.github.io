...
author: ["Jacob Hilker"]
date: 2021-06-04T00:47:00-04:00
tags: ["Emacs", "Org Mode"]
...
| Filename       | Purpose                                                                                    |
|----------------|--------------------------------------------------------------------------------------------|
| `agenda.org`   | Keeping track of events (such as appointments, meetings, tabletop campaign sessions, etc). |
| `contacts.org` | Contact management and birthdays (still in progress).                                      |
| `projects.org` | Keeping track of todo items for my personal software projects.                             |
| `todo.org`     | Shorter todo items, chores, and habits.                                                    |

As an example, I currently have a custom agenda view that's I call a GTD Dashboard - although I don't include any projects in it, I give my projects their own dashboard since some of them can get quite big for a solo project. Excuse the windows laptop, my Linux machine is currently being repaired.
