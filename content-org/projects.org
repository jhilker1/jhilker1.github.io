...
:export_hugo_custom_front_matter+: :projectrepo https://gitlab.com/jhilker/chroniclerCK3 :projectsite https://chronicler.readthedocs.io/en/latest/ 
...
:export_hugo_custom_front_matter: :featured true :status "In Development"
:export_hugo_custom_front_matter+: :srclang Python :icon devicon-python-plain 
:export_hugo_custom_front_matter+: :projectrepo https://gitlab.com/jhilker/pyronsworn :projectsite https://pyronsworn.readthedocs.io/en/latest/ 
...
* Halfmoon Wiki
:properties:
:export_hugo_bundle: hugo-halfmoon-wiki
:export_file_name: index.md
:export_hugo_custom_front_matter: :featured false :status "In Development"
:export_hugo_custom_front_matter+: :srclang HTML/CSS/JS :icon devicon-html5-plain
:export_hugo_weight: 2
 :end:
