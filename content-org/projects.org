...
:export_hugo_custom_front_matter: :featured true :srclang Python :icon devicon-python-plain :status In Development :projectrepo https://gitlab.com/jhilker/chroniclerCK3.git :projectsite https://chroniclerck3.readthedocs.io/en/latest/ :weight 1
 :end:
